...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--batch-size", type=int, default=300)
    ...
    optimizer = torchopt.FuncOptimizer(torchopt.adam(lr=learning_rate_0))
...
## running of the model
    ...
    for i in range(num_iter):
        ...
        new_params_list = []
        for params_to_update in params_list:
            params = optimizer.step(loss, params_to_update)
...
## plot solution on the given domain, TO DO: add planet and maybe change the axis to match style more 
    ...
    B_x_tensor = B_x_func(grid_points, params_list[0])
    B_y_tensor = B_y_func(grid_points, params_list[1])
